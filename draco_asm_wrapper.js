...
$jscomp.polyfillIsolated = function(k, n, l, p) {
    ...
    null != n && (k ? $jscomp.defineProperty($jscomp.polyfills, h, {
        ...
        writable: !0,
        value: n
    }) : n !== l && (void 0 === $jscomp.propertyToPolyfillSymbol[h] && (l = 1E9 * Math.random() >>> 0,
    $jscomp.propertyToPolyfillSymbol[h] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(h) : $jscomp.POLYFILL_PREFIX + l + "$" + h),
...
var DracoDecoderModule = function() {
    ...
    return function(n) {
        ...
        function p(e, b, c) {
            ...
            for (c = b; e[c] && !(c >= d); )
                ++c;
            if (16 < c - b && e.buffer && ua)
                return ua.decode(e.subarray(b, c));
            for (d = ""; b < c; ) {
                var g = e[b++];
                if (g & 128) {
                    var u = e[b++] & 63;
        ...
        function ba(e) {
            ...
            if (!(0 < aa)) {
                ...
                z(Ca);
                0 < aa || (a.setStatus ? (a.setStatus("Running..."),
                setTimeout(function() {
                    setTimeout(function() {
                        a.setStatus("")
                    }, 1);
        ...
        n = n || {};
        var a = "undefined" != typeof n ? n : {}, Aa, ja;
        ...
        var la, wa = !1, ua = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0, va, Y, ea, ca, V, Ca = [], oa = [], Ba = [], za = !1, aa = 0, qa = null, ia = null;
            ...
            d: function(e, b, c, d) {
                for (var g = 0, u = 0; u < c; u++) {
                    ...
                    for (var ra = 0; ra < cb; ra++) {
                        var sa = ea[X + ra]
                          , ta = yd[e];
                        0 === sa || 10 === sa ? ((1 === e ? wd : da)(p(ta, 0)),
                        ta.length = 0) : ta.push(sa)
                    }
                    g += cb
                }
                V[d >> 2] = g;
        ...
        var r = {
            ...
            alloc: function(b, c) {
                ...
                b = b + 7 & -8;
                r.pos + b >= r.size ? (0 < b || f(void 0),
                r.needed += b,
                c = a._malloc(b),
                r.temps.push(c)) : (c = r.buffer + r.pos,
                r.pos += b);
                return c
            },
            copy: function(b, c, d) {
